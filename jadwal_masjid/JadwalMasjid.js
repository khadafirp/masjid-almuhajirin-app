...
export default class SejarahMasjid extends React.Component {
    ...
    fetchDataSejarah = () => {
        fetch('https://us-central1-fir-firebase-f7194.cloudfunctions.net/user/listKategoriJadwal', {
            method: "GET",
            headers: {
      ...
      fetchFilterSejarah = async () => {
        var value = await AsyncStorage.getItem("kategori")
        try{
            if (value === null || value === "") {

                fetch('https://us-central1-fir-firebase-f7194.cloudfunctions.net/user/filterJadwal', {
                method: "POST",
                headers: {
                'Content-Type': 'application/json'
                },
    ...
    clearAsync = async () => {
        ...
        console.log("kategori = " + await AsyncStorage.getItem('kategori'));
    }

    _storeData = async (value) => {
        try {
          await AsyncStorage.setItem('kategori', value);
        //   this.clearAsync()
